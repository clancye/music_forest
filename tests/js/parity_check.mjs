...
const got = {
  ...
  kept_index: J.keptIndex ? J.keptIndex(choices) : null,
};
...
// FB#87: the "have I kept this already?" index has to answer identically on both
// sides — the local server reads the table, the hosted client reads decrypted rows.
cmp("kept_index", got.kept_index, exp.kept_index);
