...
echo "== journal encrypted cache (FB#107) ==" ; node journal-cache.test.mjs
echo "== notebook unreadable != empty (FB#92/#104) ==" ; node notebook-unreadable.test.mjs
...
echo "== auto-update (safe silent reload gate) ==" ; node auto-update.test.mjs
